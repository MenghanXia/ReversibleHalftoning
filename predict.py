...
class Predictor(cog.Predictor):
    ...
    @cog.input(
        ...
        type=bool,
        default=True,
        help="choose to only output the dithered input image (halftone), or both halftone and the restored image",
    )
    def predict(self, image, halftone_only):
        ...
        if halftone_only:
            ...
            result = cv2.vconcat([halftone, restored])
